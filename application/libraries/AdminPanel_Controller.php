 ...
 */
 class AdminPanel_Controller extends MY_Controller {
     public $is_admin;
     ...
     function __construct() {
         ...
         $this->_container = $this->config->item('ci_my_admin_template_dir_adminpanel') . "layout.php";
         ...
         log_message('debug', 'CI My Admin : AdminPanel_Controller class loaded');
     }
 }
